...
A cozy, immersive fireplace simulation web app built with TanStack Start.

## Features

- Realistic canvas-based fire particle animation
- Wood fire with logs and embers
- Ambient lighting effects
- Cracking fire audio (you need to provide this)
...
To enable the crackling fire sound, you need to add an audio file:

1. Find a royalty-free crackling fire sound (MP3 format)
   - FreeSound.org
   - Pixabay Audio
   - YouTube Audio Library

2. Place it at: `public/audio/fire-crackle.mp3`

3. The audio will auto-play when you click the play button

## Usage

- **Fullscreen**: Click the fullscreen button (bottom right) to enter/exit fullscreen
- **Play/Pause**: Click the play/pause button to control audio
- **Volume**: Use the slider to adjust volume
...
├── public/
│   └── audio/
│       └── fire-crackle.mp3  (You need to add this)
├── src/
│   ├── components/
│   │   ├── Fireplace.tsx      # Canvas fire animation
│   │   ├── AudioControls.tsx  # Volume and playback controls
...
- TypeScript
- Tailwind CSS
- Canvas API for fire animation
- HTML5 Audio for sound
- Fullscreen API

## Customization

You can customize the fire effect by editing `src/components/Fireplace.tsx`:
- Adjust particle count
- Change colors
- Modify particle physics
- Adjust glow effects
